if (typeof (LikeBtn) == "undefined" || !LikeBtn) {
    (function (b) {
        ...
        a.type = "text/css";
        a.rel = "stylesheet";
        a.href = "//cdn.rawgit.com/compulack/Academy/358a6090/academy/css/likebtn.css";
    ...
    var LikeBtn = function (window_obj) {
        ...
        obj.buttonShow = function (index, wrapper, data) {
            ...
            if (data.di == "1") {
                ...
                if (index >= obj.max_buttons_per_page[obj.plan] && obj.bunch_btns > obj.max_buttons_per_page[obj.plan]) {
                    ...
                    if (!obj.inArray(obj.getParameter(index, "host"), obj.https_check_disabled) && !obj.checkPlan(obj.plans.VIP) && (typeof (data.sc) == "undefined" || data.sc == "1") && "https:" == document.location.protocol) {
        ...
        obj.getHtml = function (data, index) {
            ...
            if (obj.getParameter(index, "rich_snippet")) {
                ...
                if (!item_date) {
                    item_date = "2017-05-19T00:00:00+00:00"
                }
        ...
        obj.customTheme = function (index, wrapper) {
            ...
            if (like_icon) {
                if (icon_l_url) {
                    ...
                    if (icon_l) {
                        obj.loadAsset("/css/w/icons.css?v=36", "css");
        ...
        obj.getPaymentSystemHtml = function (system, purpose) {
            ...
            if (href) {
                ...
                obj.loadAsset("/css/w/popup_donate.css?v=36", "css")
            }
            return html
        };
        ...
        obj.infoMessage = function (index, wrapper, message) {
            wrapper.innerHTML = '<a href="https://likebtn.com" class="likebtn-im" title="' + obj.escapeHTML(message.replace(/<\/?[^>]+(>|$)/g, "")
                .replace(/"/g, "'")) + '">LikeBtn.com</a> [<a href="javascript:void(0);" onclick="this.outerHTML=LikeBtn.Base64.decode(\'' + obj.Base64.encode(message) + "');\">?</a>]";
        ...
        obj.q = (function () {
            ...
            function U(e, t) {
                ...
                l = (g = g.slice(0))
                    .pop(), g.length && (f = g[g.length - 1].match(c)) && (m = K(t, f[1]));
                if (!m) {
                    return n
                }
    ...
    if (typeof (ga) == "function") {
        ...
        })(window, document, "script", "https://www.google-analytics.com/analytics.js", "likebtn_ga")
    }
    likebtn_ga("create", "UA-37384414-2", "likebtn.com", "likebtnPageviewsCounter");
    likebtn_ga("likebtnPageviewsCounter.send", "pageview")
}
LikeBtn.init(true);
